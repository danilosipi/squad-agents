...
Quero retomar oficialmente o projeto CAP usando a nova estrutura.

Considere que o contexto oficial do projeto está em D:\Drive\Projetos\cap-platform\.squad e que o código real do primeiro módulo está em D:\Drive\Projetos\cap-platform\repos\cap-base.

Não quero começar do zero. Quero que você use o contexto já existente em .squad/context.md, .squad/decisions.md, .squad/standards.md e .squad/backlog.md para me ajudar a validar o estado atual e definir a próxima tarefa real no Board.
